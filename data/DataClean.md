...
> 2.数据是在excel里面存储的，因为自己比较熟悉excel吧，但是一开始不太理解老师的意思，自己在excel上面做的表格乱七八糟的
![][1]
...
>images/twj/shu2.png
> 3.一开始是手写，后来用了Gephi，先是吧excel里面的数据按照平台上edgelist.cvs和notelist.cvs文件的格式调了自己的数据，另存为.cvs文件，然后按照老师的步骤导进软件里面生成的
> 4.参照老师给的文件，但是生成过程中发现都是这样的黑点，而且每个点没有大小之分，也不显示权值之类的，如图所示
>images/twj/er0.png
>images/twj/er1.png
