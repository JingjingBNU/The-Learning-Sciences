...
### 蒋思雨的分享
#### 1、如何收集数据的？收集过程中遇到什么问题？
【数据】2018年作者的本硕博系别以及工作后系别
【收集方法及数据来源】我主要根据the learning of science上的提供的作者工作学校（单位）来搜索其官网，然后在官网中搜索该作者名，查找数据。小部分作者无法在学校官网上找到，我会在必应中搜索其名字和单位，然后通过researchgate或者其他网页找到其简历中的系别数据。
【问题】①英语名的作者资料比较好找到，有两个中文译名的作者信息没有找到，最终只记录了他们的工作系别；②每所学校其对学科系别的分类不同，有的学校系别范围很大，有的学校系别分的很细，所以在记录数据时，系别的划分程度不一致；③部分作者找不到其本科学历，网站上只记录了他的bachelor学位；④个别作者毕业后在机构中工作，没有具体的工作系别

#### 2、数据以何种格式存放？为什么选择这样存放？
【数据存放】数据以csv格式存放
【存放原因】这样存放将每列数据以逗号隔开，便于导入github，展开后续分析

#### 3、如何生成二分网络？
【工具及选取原因】gephi，可视化操作，不用编程
【使用方法】我一开始没看到老师提供的操作教程，就先导入了edgelist，在geohi中自动生成了节点表格，我将其导出为csv，然后按照学科和学者进行分类，生成nodelist。后来按照老师在github上提供的操作教程：①导入nodelist和edgelist；②调节两类节点的颜色和大小范围；③调整二分网络的整体结构，使得网络节点不重叠

#### 4、如何进行二分网络转化？
二分网络转化为单定点网络仍然是按照老师提供的操作教程：①下载了MultiMode Networks Transformation Plugin插件；②选择left/right matrix，确定是以作者还是以学科为单定点网络；③再次调整新生成的单定点网络
![image](https://github.com/JingjingBNU/The-Learning-Sciences/blob/master/images/2018discipline_JSY.png)

#### 5、有什么新的发现来回答学习科学的学科基础这个问题？
通过查找学习科学领域的学者研究系别，记录数据时，大致发现他们主要来自与和教育、心理、哲学还有计算机相关的专业；之后通过二分网络转化为单定点网络的方法，更加直观的看出学习科学领域背后所依托的主要学科系别。但是我当时所用的数据只是2018年的，数据量过小，学科分类标准不齐，生成的网络缺乏科学性和严谨性。但是通过这样的网络，初步感受到学习科学领域作者的知识基础，为其毕业后从事学习科学领域的研究奠定一定的基础，这其中部分也构成了学习科学的学科基础，还需对大量数据再做更深入的清理和挖掘，以进一步得出结论。
